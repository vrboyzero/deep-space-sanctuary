...
- 授权窗口累计 observed=`$2.20573999`、reserved=`$0.94221000`，当前守卫上界=`25.18359992 RMB < 50 RMB`；Provider 外部账单仍待控制台核对。
