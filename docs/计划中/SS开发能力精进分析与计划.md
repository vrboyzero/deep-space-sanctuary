...
| 两个连续 9.5 候选 | P2 | **未完成（candidate-872560e-1 就绪待启动）** | 尚无完整资格和数值 score；新 identity `ab2e7388`（872560e6）inputs/config 已重建、WSL inputs 待重建 | 两个候选均须完整矩阵、七维下限、raw weighted >=9.500 和全部 hard Gate；下一候选启动待用户确认 |
