...
- `packages/belldandy-skills/src/code-intel/typescript-provider.ts`: 官方 TypeScript Language Service 的只读 live semantic Provider；负责有界 tsconfig/jsconfig/monorepo discovery、`.js/.jsx/.ts/.tsx`、workspace revision reload、受控 external root、分页/cancel 与 session dispose
