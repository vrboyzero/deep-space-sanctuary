export function createGoalsSpecialistCanvasReadLifecycle() {
  ...
  async function run(operation) {
    ...
    const token = Symbol("goal-canvas-read");
  ...
  function getRuntimeSnapshot() {
    return {
      disposed,
      goalCanvasReadGeneration: generation,
      pendingGoalCanvasReadCount: pendingReads.size,
    };
  }
