...
memoryViewerFeature = createMemoryViewerFeature({
  ...
  getMemoryCategoryDistributionViewModel: (stats) => memoryDetailRenderFeature.getMemoryCategoryDistributionViewModel(stats),
...
agentRuntimeFeature = createAgentRuntimeFeature({
  ...
  sendReq,
  makeId,
  requestModelCatalog: () => chatNetworkFeature?.requestModelCatalog?.(),
  getHttpAuthHeaders,
  getActiveConversationId: () => activeConversationId,
  setActiveConversationId: (conversationId) => {
    setActiveConversationIdValue(conversationId);
