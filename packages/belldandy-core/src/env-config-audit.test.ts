...
const MANUAL_ONLY_ENV_KEYS = [
  ...
  "BELLDANDY_CODE_INTEL_GO_COMMAND",
  "BELLDANDY_CODE_INTEL_GO_ENABLED",
  "BELLDANDY_CODE_INTEL_GOPLS_COMMAND",
  "BELLDANDY_COMMAND_SANDBOX_BACKEND",
  "BELLDANDY_COMMAND_SANDBOX_OCI_IMAGE",
  "BELLDANDY_COMMAND_SANDBOX_OCI_RUNTIME",
  "BELLDANDY_ENV_DIR",
  "BELLDANDY_EXTENSION_HOST_BACKEND",
  "BELLDANDY_EXTENSION_HOST_OCI_IMAGE",
  "BELLDANDY_EXTENSION_HOST_OCI_RUNTIME",
  "BELLDANDY_IMAGE",
  "BELLDANDY_IMAGE_ASSET_ALLOWED_HOSTS",
  "BELLDANDY_IMAGE_MAX_OUTPUT_BYTES",
  "BELLDANDY_MEMORY_DB",
  "BELLDANDY_MODEL_CACHE_CREATION_USD_PER_1M",
  ...
  "BELLDANDY_MV3_CHROME_PATH",
  "BELLDANDY_OFFICE_MAX_DOWNLOAD_BYTES",
  // Relay 凭据由 resolveRelayCredential 在 stateDir 自动生成并复用，显式配置只是可选覆盖，
  // 且明确不写入 WebChat 配置，因此保持 manual-only。
  "BELLDANDY_RELAY_TOKEN",
  "BELLDANDY_REMOTE_DELIVERY_TARGETS_JSON",
  "BELLDANDY_RUNTIME_RESOURCE_EVENT_LOOP_RESOLUTION_MS",
  "BELLDANDY_RUNTIME_RESOURCE_MAX_SAMPLES",
  "BELLDANDY_RUNTIME_RESOURCE_OBSERVABILITY_ENABLED",
  "BELLDANDY_RUNTIME_RESOURCE_SAMPLE_INTERVAL_MS",
  "BELLDANDY_SKIP_REAL_BROWSER_RELAY_TESTS",
  "BELLDANDY_TOKEN_USAGE_UPLOAD_TOKEN",
  "BELLDANDY_TOOL_RESULT_EVENT_OUTPUT_CHAR_LIMIT",
...
const SETTINGS_EXEMPT_ENV_KEYS = [
  ...
  "BELLDANDY_TTS_DASHSCOPE_BASE_URL",
  "BELLDANDY_WORKFLOW_MAX_BATCH_ITEMS",
  "BELLDANDY_WORKFLOW_MAX_BATCH_OUTPUT_BYTES",
  "BELLDANDY_WORKFLOW_MAX_BATCH_QUEUED_BYTES",
  "BELLDANDY_WORKFLOW_MAX_RETRIES",
