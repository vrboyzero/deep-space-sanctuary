...
const BUILTIN_CLI_COMMANDS: readonly CommandDescriptor[] = [
  ...
  },
  {
    ...
    channels: ["cli"],
    safeScopes: ["local-safe"],
    description: "Open the interactive Star Sanctuary coding workbench",
    handler: async () => (await import("./commands/tui.js")).default,
  },
  {
    name: "agent",
    type: "group",
    ...
    channels: ["cli"],
    safeScopes: ["local-safe"],
    description: "Run and inspect headless Conversation agents",
    handler: async () => (await import("./commands/agent.js")).default,
  },
  {
    name: "coding-run",
    type: "group",
