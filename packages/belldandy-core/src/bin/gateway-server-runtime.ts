...
export function buildGatewayServerOptions(input: GatewayServerRuntimeInput): GatewayServerOptions {
  return {
    ...
    codingRunEventBroker: input.codingRunEventBroker,
    codingRunReconciliationJournal: input.codingRunReconciliationJournal,
    taskCapabilityClosureResolver: input.taskCapabilityClosureResolver,
    ...
    pendingToolPermissionRuntime: input.pendingToolPermissionRuntime,
    ...
    emailOutboundConfirmationStore: input.emailOutboundConfirmationStore,
    emailOutboundProviderRegistry: input.emailOutboundProviderRegistry,
    emailOutboundAuditStore: input.emailOutboundAuditStore,
    emailInboundAuditStore: input.emailInboundAuditStore,
    emailFollowUpReminderStore: input.emailFollowUpReminderStore,
    ...
    getRuntimeResourceQueueSnapshots: input.getRuntimeResourceQueueSnapshots,
    ...
    workspaceRevisionRuntime: input.workspaceRevisionRuntime,
    workspaceChangeReviewRuntime: input.workspaceChangeReviewRuntime,
    userWorktreeRuntime: input.userWorktreeRuntime,
    remoteDeliveryRuntime: input.remoteDeliveryRuntime,
    commanderMode: input.commanderMode,
    toolResultEventOutputCharLimit: input.toolResultEventOutputCharLimit,
