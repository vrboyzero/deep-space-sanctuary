...
const SAFE_UPDATE_KEYS = new Set([
  ...
  "BELLDANDY_TOOL_AGENT_STREAMING_ENABLED",
  ...
  "BELLDANDY_TOKEN_USAGE_UPLOAD_TRUSTED_PRIVATE_ENDPOINT",
  "BELLDANDY_TOKEN_USAGE_STRICT_UUID",
  "BELLDANDY_WEBCHAT_COST_BUDGET_USD", "BELLDANDY_WEBCHAT_COST_BUDGET_WARN_FRACTION",
  ...
  "BELLDANDY_BROWSER_OUTBOUND_PROFILE",
  "BELLDANDY_BROWSER_ALLOWED_DOMAINS", "BELLDANDY_BROWSER_DENIED_DOMAINS",
  "BELLDANDY_BROWSER_ALLOW_INSECURE_HTTP",
  ...
  "BELLDANDY_MAX_TOOL_CALLS", "BELLDANDY_MAX_RUN_WALL_TIME_MS", "BELLDANDY_MAX_TOTAL_TOKENS", "BELLDANDY_MAX_HIGH_RISK_TOOL_CALLS",
  "BELLDANDY_TOOL_LOOP_ITERATION_BUDGET", "BELLDANDY_TOOL_LOOP_WARNING_FRACTION",
  "BELLDANDY_WEB_ALLOW_PRIVILEGED_SAFE_SCOPE",
  "BELLDANDY_WEB_FETCH_ALLOW_INSECURE_HTTP", "BELLDANDY_WEB_FETCH_ALLOW_PRIVATE_NETWORK",
  "BELLDANDY_PRIVILEGED_WORKSPACE_WRITE_CHANNELS",
  ...
  "BELLDANDY_MEMORY_BACKGROUND_MAX_RUNS", "BELLDANDY_MEMORY_BACKGROUND_WINDOW_MS",
  ...
  "BELLDANDY_TASK_MEMORY_ENABLED", "BELLDANDY_TASK_STATS_WHEN_MEMORY_DISABLED", "BELLDANDY_TASK_SUMMARY_ENABLED",
  ...
  "BELLDANDY_TTS_OPENAI_API_KEY", "BELLDANDY_TTS_OPENAI_BASE_URL", "BELLDANDY_TTS_DASHSCOPE_BASE_URL",
  ...
  "BELLDANDY_SUB_AGENT_MAX_VERIFIERS", "BELLDANDY_SUB_AGENT_MAX_COST_USD",
  "BELLDANDY_WORKFLOW_MAX_CONCURRENT", "BELLDANDY_WORKFLOW_MAX_QUEUE_SIZE",
  "BELLDANDY_WORKFLOW_TIMEOUT_MS", "BELLDANDY_WORKFLOW_AGENT_TIMEOUT_MS",
  "BELLDANDY_WORKFLOW_MAX_SCRIPT_BYTES",
  "BELLDANDY_WORKFLOW_MAX_AGENT_CALLS", "BELLDANDY_WORKFLOW_MAX_TOKENS", "BELLDANDY_WORKFLOW_MAX_RETRIES",
  "BELLDANDY_WORKFLOW_MAX_BATCH_ITEMS", "BELLDANDY_WORKFLOW_MAX_BATCH_QUEUED_BYTES",
  "BELLDANDY_WORKFLOW_MAX_BATCH_OUTPUT_BYTES", "BELLDANDY_WORKFLOW_MAX_DEPTH",
  "BELLDANDY_WORKFLOW_INLINE_ENABLED", "BELLDANDY_WORKFLOW_LEGACY_FILE_MODE",
  ...
  "BELLDANDY_COMPACTION_MAX_PTL_RETRIES", "BELLDANDY_COMPACTION_CONTEXT_WINDOW_FRACTION",
  "BELLDANDY_MODEL_CONTEXT_WINDOW",
  "BELLDANDY_MODEL_CACHE_ENABLED", "BELLDANDY_MODEL_JSON_RELIABILITY",
  ...
  "BELLDANDY_BUDGET_PROTECT_MODE", "BELLDANDY_BUDGET_PROTECT_KEEP_RECENT_ROUNDS",
  "BELLDANDY_STABLE_PREFIX_SPLIT",
  "BELLDANDY_COMPACTION_MODEL_ROUTE", "BELLDANDY_COMPACTION_MODEL",
  "BELLDANDY_DEEPSEEK_ROUTE_POLICY_ENABLED",
  "BELLDANDY_COMPACTION_BASE_URL",
  "BELLDANDY_COMPACTION_API_KEY",
  "BELLDANDY_PREFLIGHT_COMPRESSION_ENABLED", "BELLDANDY_PREFLIGHT_COMPRESSION_MODE",
  "BELLDANDY_PREFLIGHT_ATTACHMENT_THRESHOLD_CHARS", "BELLDANDY_PREFLIGHT_TARGET_RATIO",
  "BELLDANDY_PREFLIGHT_MIN_SAVINGS_RATIO", "BELLDANDY_PREFLIGHT_TIMEOUT_MS",
  "BELLDANDY_PREFLIGHT_ATTACHMENT_REFERENCE",
  "BELLDANDY_PREFLIGHT_SIDECAR_RETENTION_MS", "BELLDANDY_PREFLIGHT_SIDECAR_MAX_ENTRIES",
  ...
  "BELLDANDY_INJECT_METHOD_SKILL_LIST",
  ...
  "BELLDANDY_PROMPT_FOCUS_MAX_SECTIONS", "BELLDANDY_PROMPT_FOCUS_MAX_CHARS",
  "BELLDANDY_PROMPT_FOCUS_MAX_EXCERPT_CHARS", "BELLDANDY_PROMPT_FOCUS_MIN_SCORE",
  "BELLDANDY_REASONING_CONTENT_POLICY",
  ...
  "BELLDANDY_CHANNEL_INGRESS_MAX_CONCURRENT", "BELLDANDY_CHANNEL_INGRESS_MAX_CONCURRENT_PER_CHANNEL",
  "BELLDANDY_CHANNEL_INGRESS_MAX_PENDING_PER_SESSION", "BELLDANDY_CHANNEL_INGRESS_MAX_QUEUED",
  "BELLDANDY_CHANNEL_INGRESS_MAX_WAIT_MS", "BELLDANDY_CHANNEL_INGRESS_MAX_PAYLOAD_BYTES",
  "BELLDANDY_CHANNEL_INGRESS_MAX_QUEUED_PAYLOAD_BYTES",
  "BELLDANDY_FEISHU_APP_ID", "BELLDANDY_FEISHU_APP_SECRET", "BELLDANDY_FEISHU_AGENT_ID",
  "BELLDANDY_FEISHU_JSON_MAX_RESPONSE_BYTES", "BELLDANDY_FEISHU_RESOURCE_MAX_RESPONSE_BYTES",
  ...
  "BELLDANDY_DISCORD_REST_MAX_RESPONSE_BYTES", "BELLDANDY_DISCORD_REST_TIMEOUT_MS",
  ...
  "BELLDANDY_DEV_RUNTIME_DIST_GUARD",
  "BELLDANDY_COMMANDER_MODE", "BELLDANDY_COMMANDER_AGENT_ID",
  "BELLDANDY_GOAL_EXECUTION_MODE", "BELLDANDY_GOAL_GOVERNANCE_MODE",
