    ...
    return agent.run({
      ...
      meta: {
        ...
        _parentConversationId: launchSpec.parentConversationId,
          ...
          allowedToolFamilies: launchSpec.allowedToolFamilies,
          maxToolRiskLevel: launchSpec.maxToolRiskLevel,
          maxRunWallTimeMs: launchSpec.maxRunWallTimeMs,
          toolLoopIterationBudget: launchSpec.toolLoopIterationBudget,
          maxTotalTokens: launchSpec.maxTotalTokens,
          maxCostUsd: launchSpec.maxCostUsd,
          maxHighRiskToolCalls: launchSpec.maxHighRiskToolCalls,
            policySummary: launchSpec.policySummary,
